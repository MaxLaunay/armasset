...
.EXAMPLE 
   Set-Configuration.ps1 ` 
        ...
        -TemplateParametersFile ".\ResourcesManager\parameters_template.json" `
        -DSCFile ".\DSC\environmentDSC.ps1" `
        -SQLSetupConfigurationFile ".\SQL\ConfigurationFile.ini" `
        -SQLdatabaseFile ".\SQL\database.sql" `
        -WebPackageFile ".\WebPackage\WebPackage.zip"
.OUTPUTS 
    no output
#>
